...
<body>
    ...
    <section class="section">
        <div class="sidenav" id="sidebar">
            ...
            <a href="adminaddbranch.php" class="active">Add Branch</a>
        ...
        ?>
            <div class="container-fluid submain">
                ...
                <p style="color: white; background-color: chocolate; font-weight: bold; text-align: center; font-size: 24px;">ADD BRANCH</p>
                <div class="container addcourseform">
                <form method="post" action="onaddbranch.php">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-floating mb-2 mt-2">
                                <input type="text" class="form-control" id="branchid" placeholder="Enter Branch Id" name="branchid">
